...
fun GuiGraphics.drawTexturedQuad(texture: ResourceLocation, x0: Float, y0: Float, x1: Float, y1: Float, u0: Float, v0: Float, u1: Float, v1: Float) {
...
fun AbstractWidget.isClicked(mouseX: Double, mouseY: Double) =
    this.isActive && this.visible && (mouseX >= x.toDouble()) && (mouseY >= y.toDouble()) && (mouseX < (this.x + this.width).toDouble()) && (mouseY < (this.y + this.height).toDouble())


fun drawBlockIcon(graphics: GuiGraphics, icon: ResourceLocation, overlay: ResourceLocation = ResourceLocation("ae2", "textures/part/p2p_tunnel_front.png"), x: Int, y: Int, width: Int = 16, height: Int = 16) {
