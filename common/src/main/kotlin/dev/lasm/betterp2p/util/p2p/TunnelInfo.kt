 ...
 */
open class TunnelInfo(val index: Int, val stack: ItemStack, val clazz: Class<out P2PTunnelPart<*>>) {
    val dispName: String =
        stack.displayName.string ?: "§c<Unknown P2P Type>"
}
 ...
 */
class ClientTunnelInfo(index: Int, stack: ItemStack, clazz: Class<out P2PTunnelPart<*>>,
